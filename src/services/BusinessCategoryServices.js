...
const BusinessCategoryServices = {
  createRecord: async (businessData) => {
    return await BusinessCategory.create(businessData)
      .then((createRes) => {
        return createRes;
      })
      .catch((err) => {
  ...
  allRecord: async (condition = {}) => {
    return await BusinessCategory.find(condition)
      .then((createRes) => {
        return createRes;
      })
      .catch((err) => {
  ...
  oneRecord: async (condition = {}) => {
    return await BusinessCategory.findOne(condition)
      .then((createRes) => {
        return createRes;
      })
      .catch((err) => {
  ...
  updateRecord: async function (findPattern, updatePattern) {
    ...
    return BusinessCategory.findOneAndUpdate(
      findPattern,
      updatePattern,
      options
    )
  ...
  getPaginatedData: async function (
    findPattern,
    sortPattern,
    page_no = 1,
    limit = 10,
    ...
    return await BusinessCategory.paginate(query, options)
  ...
  getAggregatePaginatedData: async function (
    ...
    return await BusinessCategory.aggregatePaginate(myAggregate, options)
      .then(async (paginatedData) => {
        return paginatedData;
      })
      .catch((err) => {
  ...
  getDataCount: async function (findPattern) {
    return BusinessCategory.countDocuments(findPattern)
      .then((count) => {
        return count;
      })
      .catch((err) => {
