...
module.exports = {
  ...
  PHONE_ALREADY_REGISTERED: "Mobile Number already registered.",
  ...
  EMAIL_ALREADY_REGISTERED_ADMIN: "Email Address already exists",
  ...
  CHANGE_PROFILE_SUCCESS: "Profile Updated Successfully.",
  ...
  ACCOUNT_IS_DEACTIVATE:
    "Your Account has been deactivated by Athwas Admin. Kindly, contact the Admin",
  ACCOUNT_IS_DELETED:
  ...
  USERLOCATION_UPDATE_SUCCESS: "User location  has been updated successfully.",
  USER_STATUS_UPDATE_SUCCESS: "User status has been updated successfully.",
  USER_DELETE_SUCCESS: "User has deleted successfully.",
  NO_USERS_EXIST: "No users found.",

  INVALID_OTP_REQUEST: "Invalid OTP",
  ...
  NOT_ALLOW_TO_USE_FREE_SUBSCRIPTION:
    "You are not able to use Free Membership now.",
  SUBSCRIPTION_PURCHASE_SUCCESS:
    "You have purchased subscription successfully.",
  NO_ACTIVATED_SUBSCRIPTION_EXIST: "No activated subscription plan yet.",
  NO_SUBSCRIPTION_EXIST:
    "You don't have any subscription plan. Please upgrade your subscription plan.",
  SUBSCRIPTION_DATE_EXPIRED:
    "Your subscription plan has expired. Please upgrade your subscription plan.",
  SUBSCRIPTION_POSTS_LIMIT_EXCEEDED:
    "You have exceeded your featured posts limit. Please upgrade your subscription plan.",

  CONTACT_REQUEST_SUCCESS: "Your request has submitted successfully.",

  ADMIN_NOT_EXIST: "Admin doesn't exist.",
  ADMIN_UPDATE_SUCCESS: "Profile details has been updated successfully.",

  SUBADMIN_CREATE_SUCCESS: "Sub admin has created successfully.",
  SUBADMIN_UPDATE_SUCCESS: "Sub admin details has been updated successfully.",
  ...
  VOUCHER_UPDATE_SUCCESS: "Voucher details has been updated successfully.",
  ...
  BUSINESS_CATEGORY_CREATE_SUCCESS:
    "Business category has created successfully.",
  BUSINESS_CATEGORY_NOT_EXIST: "Business category doesn't exist.",
  BUSINESS_CATEGORY_UPDATE_SUCCESS:
    "Business category details has been updated successfully.",
  BUSINESS_CATEGORY_STATUS_UPDATE_SUCCESS:
    "Business category status has been updated successfully.",
  BUSINESS_CATEGORY_DELETE_SUCCESS:
    "Business category has deleted successfully.",
  BUSINESS_CATEGORY_ALREADY_EXIST:
    "Business category with this name already exist.",
  // CATEGORY
  ...
  CATEGORY_UPDATE_SUCCESS: "Category details has been updated successfully.",
  ...
  SUB_CATEGORY_EXIST: "Sub Category already exists.",
  SUB_CATEGORY_UPDATE_SUCCESS:
    "Sub Category details has been updated successfully.",
  SUB_CATEGORY_STATUS_UPDATE_SUCCESS:
    "Sub Category status has been updated successfully.",
  ...
  CART_UPDATE_SUCCESS: "Cart has been updated successfully.",
  ...
  INSUFFICIENT_REDEEM_POINT:
    "You have insufficient redeem point in your wallet.",
  ...
  PRODUCT_NOT_EXIST:
    "Item Out of Stock! You will be notified through notification when this item is restocked",
  PRODUCT_UPDATE_SUCCESS: "Product details has been updated successfully.",
  ...
  Warehouse_DATA_DELETE_SUCCESS:
    "Product Warehouse inventory has deleted successfully.",

  // BRAND
  BRAND_CREATE_SUCCESS: "Brand has created successfully.",
  BRAND_NOT_EXIST: "Brand doesn't exist.",
  BRAND_UPDATE_SUCCESS: "Brand details has been updated successfully.",
  BRAND_STATUS_UPDATE_SUCCESS: "Brand status has been updated successfully.",
  BRAND_DELETE_SUCCESS: "Brand has deleted successfully.",
  BRAND_NAME_ALREADY_USED: "Brand name is already exists",

  // SETTING
  SETTING_UPDATE_SUCCESS: "Setting details has been updated successfully.",
  SETTING_NOT_EXIST: "Setting doesn't exist.",

  // WAREHOUSE
  WAREHOUSE_CREATE_SUCCESS: "WAREHOUSE has been created successfully.",
  WAREHOUSE_NOT_EXIST: "WAREHOUSE doesn't exist.",
  WAREHOUSE_UPDATE_SUCCESS: "WAREHOUSE details has been updated successfully.",
  WAREHOUSE_STATUS_UPDATE_SUCCESS:
    "WAREHOUSE status has been updated successfully.",
  WAREHOUSE_DELETE_SUCCESS: "WAREHOUSE has been deleted successfully.",
  ...
  DEFAULT_ADDRESS_UPDATE_SUCCESS:
    "Default Address has been  updated successfully.",
  // CUSTOMIZATION TYPE
  TYPE_CREATE_SUCCESS: "Customization type has created successfully.",
  TYPE_VALUE_CREATE_SUCCESS:
    "Customization type value has created successfully.",
  TYPE_UPDATE_SUCCESS: "Type details has been updated successfully.",
  ...
  SUB_TYPE_VALUE_CREATE_SUCCESS:
    "Customization type value has created successfully.",
  SUB_TYPE_UPDATE_SUCCESS: "Sub Type details has been updated successfully.",
  ...
  // FAVOURITE ITEMS
  FAV_CREATE_SUCCESS: "Item successfully added to your Wish list.",
  ...
  // CONTENT
  CONTENT_UPDATE_SUCCESS: "Content has been updated successfully.",
  ...
  FAQ_UPDATE_SUCCESS: "FAQ details has been updated successfully.",
  ...
  BANNER_UPDATE_SUCCESS: "Banner details has been updated successfully.",
  BANNER_STATUS_UPDATE_SUCCESS: "Banner status has been updated successfully.",
  ...
  DEALOFDAY_UPDATE_SUCCESS:
    "Deal of day details has been updated successfully.",
  DEALOFDAY_STATUS_UPDATE_SUCCESS:
    "Deal of day status has been updated successfully.",
  ...
  // CUSTOMER RATING
  RATING_UPDATE_SUCCESS: "Rating details has been updated successfully.",
  RATING_SUBMITTED_SUCCESS: "Rating submitted successfully.",

  INVENTORY_NOT_EXIST: "Inventory not exist.",
  RATING_STATUS_UPDATE_SUCCESS: "Rating status has been updated successfully.",
  ...
  OFFER_UPDATE_SUCCESS: "Offer has been updated successfully.",
  OFFER_EXIST: "Promocode already exists.",
  ...
  NEW_ADDRESS: "Address added successfully",
  //Customization Filter
  CUSTOMIZE_TYPE_FETCH_SUCCESSFULLY:
    "Customization type list fetch successfully.",
  CUSTOMIZE_SUBTYPE_FETCH_SUCCESSFULLY:
    "Customization sub type list fetch successfully.",

  //For order place
  DELIVERY_FEES_CHANGE: "Delivery fees change please check order again.",
  WAREHOUSE_NOT_FOUND_NEAR_YOU:
    "Warehouse not found with this product near by you.",
  ...
  PRODUCT_CART_IS_NOT_VALID: "Promocode is not applicable on this Cart",
  USER_CANNOT_DELETE:
    "You don't have permission to delete because the order is in process",
  OFFER_PRICE_MUST_OFFER_AMOUT:
    "Offer Price should not be greater than Product Price",
};
