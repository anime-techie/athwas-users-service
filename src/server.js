...
app.use('/user_service/admin', AdminRoutes);
app.use('/user_service/customer', CustomerRoutes);
app.use('/user_service/driver', DriverRoutes);
app.use(
	'/user_service/validate_authorization/',
