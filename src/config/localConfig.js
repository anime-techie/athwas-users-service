...
module.exports = {
	...
	// mongoURI:
	//   "mongodb://footprint:cQZMR[LqbtB8E@3.7.46.171:27017/grocery-live-user-service?authSource=admin",
	mongoURI:
		'mongodb+srv://athwas:athwas@cluster0.jmpbb.mongodb.net/grocery-live-users-service?retryWrites=true&w=majority',

	expressPort: process.env.PORT || 3051,
	siteUrl: 'http://192.168.1.177:3051',
	rootPath: rootPath,
	...
	// 	port: 6379,
	// 	host: '127.0.0.1',
	// 	prefix: 'redis-instance.fvdszj.ng.0001.aps1.cache.amazonaws.com:6379',
	// 	// password:
