...
const UPLOAD_FOLDER_URL =
  ...
  "/service/assets?service=user_service&filepath=uploads/business_category";
...
BusinessCategorySchema.virtual("category_image_thumb_url").get(function (
  value
) {
  if (this.category_image != "") {
...
BusinessCategorySchema.plugin(uniqueValidator, {
  message: "Business category with this {PATH} already exist.",
});
